    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700">
          ...
          <li>É 100% interoperável com Java, ou seja, você pode usar bibliotecas e frameworks Java no seu código Kotlin sem problemas.</li>
          <li>Sintaxe moderna e expressiva: A linguagem tem uma sintaxe mais moderna, com recursos como expressões lambda, funções de alta ordem, data classes, etc. Esses recursos tornam o desenvolvimento mais produtivo e menos propenso a erros.</li>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">Desvantagens</h2>
        <ul className="list-disc list-inside text-gray-700">
          <li>Compilação mais lenta em comparação ao Java: A compilação de código Kotlin pode ser um pouco mais lenta do que a de Java, especialmente em projetos grandes, o que pode impactar a produtividade do desenvolvedor em projetos de grande escala.</li>
          <li>Menor base de código e ecossistema: Embora Kotlin esteja crescendo rapidamente, o ecossistema de ferramentas, bibliotecas e frameworks não é tão vasto quanto o de Java.</li>
